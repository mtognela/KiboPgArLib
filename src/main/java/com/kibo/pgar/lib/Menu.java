 ...
 * <p>
 * It is assumed that the exit option is always associated with choice 0 and is
 * presented at the bottom of the menu (when it must be shown).
 *
 * @author Minini Luca
 */
...
public final class Menu {
    ...
    /**
     * Constructs a <code>MyMenu</code> with the given title and options, showing
     * the exit option by default.
     *
    ...
    /**
     * Constructs a <code>MyMenu</code> with the given title, options, and whether
     * to show the exit option.
     *
     * @param title          The title of the menu.
     * @param options        The array of menu options.
    ...
    public void displayMenu() {
        String prettifiedTitle = PrettyStrings.pretty(AnsiColors.GREEN, AnsiWeights.BOLD, null, this.title);
